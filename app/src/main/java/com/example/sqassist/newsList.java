...
public class newsList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsText1 = v.findViewById(R.id.newsName1);
        newsText2 = v.findViewById(R.id.newsName2);

        newsText1.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View view) {
                getParentFragmentManager().beginTransaction().replace(R.id.news_container, new NewsDetailsOne()).commit();
            }
        });
        ...
        newsText2.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View view) {
                getParentFragmentManager().beginTransaction().replace(R.id.news_container, new NewsDetailsTwo()).commit();
            }
        });
        return v;
    }
